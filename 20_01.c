/*
 ...
 Version     : 1.0
 Copyright   : © 2017 
 Description : A Simple Stream Server in C
 ============================================================================
 */
...
* the use :		 telnet remotehostname 3490 "where remotehostname is the name of the machine you're running it on."
*/
...
int main(void)
{
	...
	while(1) {  // main accept() loop
		...
		if (!fork()) { // this is the child process
			...
			if (send(new_fd, "Hello, world! #r00G_G33k", 30	, 0) == -1)
				perror("send");
			close(new_fd);
			exit(0);
		}
